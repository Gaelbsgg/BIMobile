...
export const dashboardCopy = {
  ...
  userRole: 'Premium Access',
  nav: [
    { label: 'Overview', icon: 'dashboard', href: '/dashboard', active: true },
    { label: 'Sales', icon: 'payments', href: '/dashboard/vendas' },
    { label: 'Finance', icon: 'account_balance', href: '/dashboard/financeiro' },
    { label: 'Inventory', icon: 'inventory_2', href: '/dashboard/estoque' },
    { label: 'Employees', icon: 'badge', href: '/dashboard/funcionarios' },
